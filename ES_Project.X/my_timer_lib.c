...
// Function to setup a specified timer with a provided period
...
// Function to busy wait on the timer flag until it is raised
...
// Function to wait the number of ms on the specified timer
